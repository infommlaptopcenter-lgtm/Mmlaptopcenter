    ...
    <div className="overflow-hidden rounded-xl border border-[#d8a928]/20 bg-white">
      <div className="overflow-x-auto">
        <table className="w-full text-left text-sm">
          <thead>
            <tr className="border-b border-[#d8a928]/20 bg-[#fcf5e8]">
              {[
                "Author",
                "Rating",
                "Content",
                ...
                <th key={h} className="px-4 py-3 font-medium text-[#0a0a0a]">
                  {h}
                </th>
              ))}
            </tr>
    ...
    <tr className="border-b border-gray-100 hover:bg-[#fcf5e8]/30">
      <td className="px-4 py-3">
        ...
        {review.isVerifiedPurchase && (
          <span className="mt-1 flex items-center gap-1 text-[10px] text-[#f6a45d]">
      ...
      <td className="max-w-xs px-4 py-3">
        <div className="truncate text-sm text-[#5A5E55]" title={review.content}>
      ...
      <td className="px-4 py-3">
        <div className="flex items-center gap-2">
          ...
          <Button onClick={() => openModal(review)} title="Edit" color="gold">
            <Edit3 />
          </Button>
          <Button
...
function Button({
  ...
  const colors = {
    ...
    gold: "text-[#d8a928] hover:bg-[#d8a928]/10",
  };
  return (
    <button
      onClick={onClick}
      className={`rounded p-1 ${colors[color]}`}
      title={title}
    >
      {children}
    </button>
